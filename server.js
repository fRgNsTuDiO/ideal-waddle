...
<head>
    ...
    <meta name="description" content="Nothing spesial here">
    <meta name="robots" content="archive, follow, imageindex, index, odp, snippet, translate">
    <meta name="author" content="">
    <title>Home - Gilz API</title>
    <meta content="Gilz - API adalah Website Rest - API untuk memenuhi segala jenis kebutuhan pada Bot WhatsApp Anda." name="description">
    <meta content="Gilz - API, Rest - API Gilz, Rest - API" name="keywords">
    <meta property="og:site_name" name="og:site_name" content="Zeeoneofc Api">
    <meta property="og:title" name="og:title" content="Gilz - Api">
    <meta property="og:url" name="og:url" content="https://hadehhhh.herokuapp.com/">
    <meta property="og:description" name="og:description" content="Nothing spesial here">
    	<script src="https://cdn.rawgit.com/bungfrangki/efeksalju/2a7805c7/efek-salju.js" type="text/javascript"> </script>
     <link rel="stylesheet" href="vendors/mdi/css/materialdesignicons.min.css">
    <meta name="msapplication-TileColor" content="#ffffff">
    <link rel="shortcut icon" href="https://files.catbox.moe/7ccob1.jpg" type="image/x-icon" />
    <meta name="theme-color" content="#ffffff">
    <link rel="canonical" href="https://hadehhhh.herokuapp.com/">
</head>

<body>
    <div class="text">
        <div class="status">
            <p></br></br></br></br></br></br></br></br></br></br></br></br></br>STATUS : <span class="typed-text"></span><span class="cursor typing"></span></p>
        </div>
        <hr>
        <div class="readdocs">
            <p>OPEN <a href="/auth/login" class="docs">DOCS.</a></p>
        </div>
    </div>
    <div class="bottom">
        <p align="center">
            <a href="http://wa.me/6285806059974" rel="noopener noreferrer" class="text"><i class="mdi mdi-whatsapp"></i>Whatsapp</a>
        </p>
    </div>
</body>
<style>
...
html {
    background: url(https://files.catbox.moe/7ccob1.jpg) no-repeat center center fixed;
